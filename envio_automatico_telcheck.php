...
$query = mysqli_query($con, "SELECT FECHA_TOMA_MUESTRA, APELLIDO_PATERNO, APELLIDO_MATERNO, NOMBRE_S, DISNEA, id, TELEFONO, RESULTADO_DEFINITIVO, RESULTADO_PARCIAL, FOLIO_DE_LA_MUESTRA  FROM datos_22052020_SIN_copy");
...
$archivo_mensaje= "Mensajes_23052020.txt";
